...
export type Database = {
  ...
  public: {
    Tables: {
      agent_campaign_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agent_campaign_events_workspace_id_fkey"
      ...
      agent_memory_snapshots: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agent_memory_snapshots_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      content_folders: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "content_folders_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      content_scripts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "content_scripts_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      content_videos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "content_videos_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      conversation_state: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "conversation_state_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      funnel_conversions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "funnel_conversions_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      funnel_step_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "funnel_step_events_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      product_agents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_agents_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_customer_profile: { Args: { p_contact_id: string }; Returns: Json }
