import { Users, BarChart3, MessageSquare, Send, LogOut, Zap, Settings, Sparkles, Video, TrendingUp, Bot, Target, Package, Megaphone } from "lucide-react";
...
const navItems = [
  ...
  { title: "Marketing & PR", url: "/marketing", icon: Megaphone },
